...
!function(e) {
    ...
    e.fn.uploadFile = function(t) {
        ...
        ,
        this.createProgress = function(e, a, t, fFileName, seqNo) {
            var r = new m(this,w);
            r.progressDiv.show(),
            ...
            r.download.click(function() {
                w.downloadCallback && w.downloadCallback.call(C, [e], fFileName)
            })),
            w.showDelete && (r.del.show(),
            r.del.click(function() {
                r.statusbar.hide().remove();
                var a = [e];
                w.deleteCallback && w.deleteCallback.call(this, seqNo, fFileName),
                C.selectedFiles -= 1,
                c(w, C)
            })),
            r
